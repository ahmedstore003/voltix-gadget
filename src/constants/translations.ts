...
export const translations: Record<Language, TranslationDict> = {
  fr: {
    ...
    shippingBadge: 'Livraison Gratuite à Casablanca & Paiement à la Livraison',
    ...
    trendingSub: 'L\'intégralité du catalogue AtlasTrends, livraison COD à Casablanca.',
    ...
    checkoutCartSub: 'Payez en espèces lors de la livraison à votre domicile à Casablanca !',
    ...
    pdpFeatureShippingDesc: 'À Casablanca',
  ...
  ar: {
    ...
    shippingBadge: 'توصيل مجاني للدار البيضاء والدفع عند الاستلام',
    ...
    address: 'عنوان التوصيل (فقط الدار البيضاء)',
    ...
    trendingSub: 'اكتشف جميع منتجات AtlasTrends مع الدفع عند الاستلام في الدار البيضاء.',
    ...
    checkoutCartSub: 'ادفع نقداً عند توصيل طلبك إلى باب منزلك في الدار البيضاء !',
    ...
    pdpFeatureShippingDesc: 'في الدار البيضاء',
